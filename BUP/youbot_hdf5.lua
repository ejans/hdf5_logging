...
logger_conf=[[
{
   { blockname='youbot1', portname="base_msr_twist", buff_len=1, port_var="vel.x", dataset_name="x", dataset_type="double[1]", group_name="/State/Twist/LinearVelocity/" },
   { blockname='youbot1', portname="base_msr_twist", buff_len=1, port_var="vel.y", dataset_name="y", dataset_type="double[1]", group_name="/State/Twist/LinearVelocity/" }
}
]]
...
ptrig2=ubx.block_create(ni, "std_triggers/ptrig", "ptrig2",
                        { period={sec=0, usec=250000 },
                          trig_blocks={ { b=hdf5_log1, num_steps=1, measure=0 } } } )
